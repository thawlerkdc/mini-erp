...
_TENANT_MIGRATIONS = [
    ...
    "UPDATE products SET created_at = COALESCE(created_at, TO_CHAR(NOW(), 'YYYY-MM-DD HH24:MI:SS')) WHERE created_at IS NULL OR BTRIM(created_at) = ''",
    "UPDATE clients SET created_at = COALESCE(created_at, TO_CHAR(NOW(), 'YYYY-MM-DD HH24:MI:SS')) WHERE created_at IS NULL OR BTRIM(created_at) = ''",
    "UPDATE suppliers SET created_at = COALESCE(created_at, TO_CHAR(NOW(), 'YYYY-MM-DD HH24:MI:SS')) WHERE created_at IS NULL OR BTRIM(created_at) = ''",
    "UPDATE categories SET created_at = COALESCE(created_at, TO_CHAR(NOW(), 'YYYY-MM-DD HH24:MI:SS')) WHERE created_at IS NULL OR BTRIM(created_at) = ''",
    "UPDATE units SET created_at = COALESCE(created_at, TO_CHAR(NOW(), 'YYYY-MM-DD HH24:MI:SS')) WHERE created_at IS NULL OR BTRIM(created_at) = ''",
